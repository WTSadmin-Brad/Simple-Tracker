...
/**
 * Admin Tickets Management Page Error UI
...
export default function TicketsError({
  ...
  useEffect(() => {
    ...
    console.error('Tickets management page error:', error);
  }, [error]);
    ...
    <div className="container py-6">
      <div className="bg-red-50 border border-red-200 rounded-lg p-6">
        ...
        <p className="text-red-700 mb-4">
          There was an error loading the ticket management data. Please try again.
        </p>
